    ...
    return __awaiter(this, arguments, void 0, function (limit, offset) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("https://pokeapi.co/api/v2/pokemon?limit=".concat(limit, "&offset=").concat(offset))];
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("https://pokeapi.co/api/v2/pokemon/".concat(nameOrId))];
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
